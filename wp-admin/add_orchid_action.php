<?php
	...
	$sql="INSERT INTO orchid_varity(KeywordID, orchid_name_th, ochid_name_eng, family_id, Orchid_Content1,  orchid_url, UpdateDate, Status) VALUES('".$set_num."', '".$nameTH."', '".$nameEN."', '".$orchid_family."', '".$detail."', '".$orchid_url."',now(),'Y')";
