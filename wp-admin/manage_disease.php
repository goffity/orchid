...
<div id="dashboard-widgets-wrap">
	<p align="center"><a href="add_disease.php">เพิ่มโรคกล้วยไม้</a></p>
	<table width="900" border="0" align="center" cellpadding="0" cellspacing="2">
      <tr>
        <td width="55" height="30" style="background-color:#C8D5E4;"><div align="center">No.</div></td>
        <td width="357" height="30" style="background-color:#C8D5E4;"><div align="center">ชื่อโรคกล้วยไม้ </div></td>
        <td width="361" height="30" style="background-color:#C8D5E4;"><div align="center">สกุลที่พบโรค</div></td>
        <td width="117" height="30" style="background-color:#C8D5E4;"><div align="center">Manage</div></td>
      </tr>
<?php 
// แก้ถึงนี้
$sql= "SELECT 
	...
	$CheckRow = mysql_num_rows($checkResult);
		...
		$MAX_PAGE = ceil($MAX_PAGE/$page_size);
		 ...
		 $sql2="SELECT 
			...
			key_id
		FROM disease 
		ORDER BY DiseaseID ASC LIMIT ".$offset.", ".$rowcount ;
...
<? $count++;}?>    
	...
	<p><table width="510" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
	  <tr>
