...
function _wp_menu_output( $menu, $submenu, $submenu_as_parent = true ) {
	...
	//jam code //040654 start
	printf("<a href=\"manage_orchid.php\">พันธุ์กล้วยไม้</a>");
	printf("<a href=\"manage_disease.php\">โรคกล้วยไม้</a>");
	printf("<a href=\"manage_research.php\">งานวิจัยกล้วยไม้</a>");
	echo "<br>";
	echo "<br>";
