...
function custom_comment($comment, $args, $depth)
{
    ...
    <fieldset class='comment'>
        ...
        <?php
			...
			if(userphoto_exists($comment->user_id)){ echo userphoto_thumbnail($comment->user_id,'', '', '', 'class="avatar avatar-32 photo avatar-default"', ''); }else{ echo get_avatar($comment, $args['avatar_size']);} 
