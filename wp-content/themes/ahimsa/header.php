...
<table border=0 cellpadding=0 cellspacing=0>
    ...
    <tr>
    <td id='title' width="40%"><a href="<?php echo get_option('home'); ?>/"><div class="xx"><?php bloginfo('name'); ?></div></a></td>
    <td id='description'><div class="xx2"><?php bloginfo('description'); ?></div></td>
