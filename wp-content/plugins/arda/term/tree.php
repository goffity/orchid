...
//connect to database
//$pathdb=plugins_url('/common.php', __FILE__);
//include($pathdb);
include("../common.php");
...
$table = "arda.ontology";        /* database table working on */
...
*/
	...
	//$termact=plugins_url('/tree.php', __FILE__); 

echo '<table><tr><td>';
//echo '<form name="manageonto" method="post" action="'.$termact.'/term/tree.php">';
echo '<form name="manageonto" method="post" action="'.$termact.'">';
